      ...
      <footer className="text-gray-600 body-font px-3 rounded-tl-lg rounded-tr-lg bg-white">
        <div className="container  py-8 mx-auto flex items-center sm:flex-row flex-col">
          ...
          <span className="inline-flex sm:ml-auto sm:mt-0 mt-4 justify-center sm:justify-start">
            <Link href={""} className="bg-mainColor2 hover:bg-mainColor text-mainColor3 hover:text-black px-2 py-2 rounded-full">
              <FaFacebookF className="" size={20} />
            </Link>
            <Link
              href={""}
              className="ml-3 bg-mainColor2 hover:bg-mainColor text-mainColor3 hover:text-black px-2 py-2 rounded-full "
            >
