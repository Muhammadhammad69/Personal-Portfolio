        ...
        <div className="  pb-20 pt-16 mx-auto">
          ...
          <div className="flex flex-col sm:flex-row flex-wrap sm:-m-4 -mx-4 -mb-10 -mt-4 items-center">
            {skillsData.map((skill: Skills, i: number) => {
              return (
                <div className="p-4 w-[90%] sm:w-1/2 md:w-1/3 " key={i} data-aos-delay={(skill.id * 100) + 100} data-aos="fade-up">
                  <div className="flex items-center  gap-3">
                    <div className="w-10 h-10 my-auto inline-flex items-center justify-center rounded-full bg-mainColor text-black shrink-0">
                  ...
                  <div className="grow w-full h-2 border border-mainColor mt-4 rounded-full py-[0.24rem] px-[0.2rem]  flex items-center  ">
                    <div
