...
export const Contact = () => {
  return (
    <LayoutWrapper>
      ...
      <h1 className="text-textColor font-bold text-4xl sm:text-5xl text-center " data-aos="fade-up" >Contact Us</h1>
        <div className="container  py-16 mx-auto flex sm:flex-nowrap flex-wrap" data-aos="fade-up">
